(() => {
  ...
  const wizard = {
    ...
    presetStep() {
      ...
      return `<p>Preset ustawia bezpieczne wartości początkowe. Każdą opcję można później zmienić.</p><div class="preset-grid">${tiles}</div>`;
    },
